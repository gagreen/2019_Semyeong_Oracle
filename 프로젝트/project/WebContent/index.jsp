...
<%@ page import="updateData.dbExcute"%>
<%@ page import="org.jsoup.*" %>
<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>

<jsp:useBean id="dbexcute" class="updateData.dbExcute" scope="page" />
...
<%
	...
	int curr = Integer.parseInt(sf.format(currentTime));
	
	if(hmin < curr && hmax > curr ){
		dbexcute.excute();
	}
...
<%
	...
	String uid = "scott";
	String upw = "tiger";
	String query = "SELECT * FROM nba_east_rank ORDER BY rank";
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
 	...
 	<ul>
      <li><a class="active" href="index.jsp">NBA <strong>EAST</strong></a></li>
